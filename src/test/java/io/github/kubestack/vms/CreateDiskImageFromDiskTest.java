...
public class CreateDiskImageFromDiskTest {
	...
	public static void main(String[] args) throws Exception {
		...
		boolean successful = client.virtualMachineDiskImages()
				.createDiskImageFromDisk("sdkimage2", "vm.node131", get(), "abcd");
	...
	protected static CreateDiskImageFromDisk get() {
		...
		createDiskImageFromDisk.setTargetPool("poolhub111-image");
		createDiskImageFromDisk.setSourcePool("poolhub111");
		createDiskImageFromDisk.setSourceVolume("diskhub111");
