...
public class RegExpUtils {
	...
	@FieldDescriber("磁盘镜像类型，iso，qcow2之一")
	public final static String IMAGE_TYPE_PATTERN = "iso|qcow2";
...
//	 22 <= tcp.src <= 100 && （ ip4.src == $dmz || ip4.src == 192.168.1.0/24 ）
	...
	public final static String POOL_TYPE_PATTERN = "localfs|dir|cephfs";
